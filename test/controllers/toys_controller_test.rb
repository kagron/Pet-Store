...
class ToysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create toy" do
    assert_difference('Toy.count') do
      post toys_url, params: { toy: { brand: @toy.brand, description: @toy.description, quantity: @toy.quantity, type: @toy.type } }
    end
  ...
  test "should update toy" do
    patch toy_url(@toy), params: { toy: { brand: @toy.brand, description: @toy.description, quantity: @toy.quantity, type: @toy.type } }
